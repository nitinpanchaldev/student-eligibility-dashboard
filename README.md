...
└── screenshots/
    ├── Dark Mode.png
    ├── Delete.png
    ├── Eligibility score.png
    ├── Form fill.png
    ├── History table.png
    ├── Light mode.png
    ├── Not eligible.png
    └── PDF format download.png
```
...
![Form Fill](screenshots/Form%20fill.png)

![Eligibility Score](screenshots/Eligibility%20score.png)

![History Table](screenshots/History%20table.png)

![Delete](screenshots/Delete.png)

![Not Eligible](screenshots/Not%20eligible.png)

![PDF Download](screenshots/PDF%20format%20download.png)
